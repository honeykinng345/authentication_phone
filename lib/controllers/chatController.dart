...
import 'package:geekfleet/widgets/fullSizePhoto.dart';
...
class ChatController extends ControllerMVC {
  ...
  Future uploadFile(peerId, type) async {
    ...
    TaskSnapshot addImg = await reference.putFile(
        type == 1 ? imageFile : videoFile,
        type == 2
            ? SettableMetadata(contentType: 'video/mp4')
            : SettableMetadata(contentType: 'image/jpeg'));
    addImg.ref.getDownloadURL().then((downloadUrl) async {
      fileUrl = downloadUrl;
  ...
  Future<void> uploadThumbFile(file, time) async {
    ...
    await addImg.ref.getDownloadURL().then((downloadUrl) {
      FirebaseFirestore.instance
          .collection('messages')
          .doc(groupChatId)
                            ...
                            child: Container(
                              child: new Wrap(
                                children: <Widget>[
                                  ...
                                  new ListTile(
                                    leading: new Icon(Icons.video_collection_outlined),
